  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      fetch("/reviews", {
        ...
        .then((newReview) => {
          resetForm();
          onReviewAdded?.(newReview); // optional chaining
        })
  ...
  return (
    <div className="review-form-card">
      ...
      <form onSubmit={formik.handleSubmit}>
          ...
          <div className="star-inputs">
            {[1, 2, 3, 4, 5].map((num) => (
              <label key={num} className="star-label">
                ...
                />
                <span className={formik.values.rating >= num ? "star filled" : "star"}>
                  ★
                </span>
              </label>
            ))}
        ...
        <button type="submit" className="btn-primary" disabled={isSubmitting || !formik.isValid}>
